...
class State(object):
    ...
    def notify_begin(self):
        ...
        #print('sss')
        #import numpy as np
        #assert (np.array(self.remain_cards['S']) > 0).all()
        if LOGGING:
    ...
    def notify_play(self):
        ...
        if self._curAction[2] != "PASS":
            for card in self._curAction[2]:
                ...
                assert self.remain_cards[card_type][x] >= 0
...
if __name__ == '__main__':
    ...
    message = {'type': 'notify', 'stage': 'episodeOver', 'curRank': '7', 'order': [0, 2, 1, 3], 'restCards': [[1, ['S2', 'S3', 'C3', 'D3', 'S5', 'H5', 'C5', 'S6', 'ST', 'CT']], [3, ['H2', 'D2', 'S4', 'S5', 'H5', 'D5', 'S6', 'H6', 'C8', 'D8', 'C9', 'C9', 'D9', 'HT', 'CT', 'DT', 'CJ', 'HQ', 'CQ', 'DQ', 'SK', 'HK', 'DK', 'HA', 'S7', 'C7', 'SB']]], 'class': 'game'}
    state.parse(message)